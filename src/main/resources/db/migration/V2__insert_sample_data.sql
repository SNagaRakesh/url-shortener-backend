...
VALUES ('admin@gmail.com', 'admin', 'Administrator', 'ROLE_ADMIN'),
       ('rakesh@gmail.com', 'secret', 'Rakesh', 'ROLE_USER');
...
VALUES
    ('rs1Aed',
     'https://www.sivalabs.in/code-offline-with-local-ai-ollama',
     1,
     '2024-07-15 00:00:00',
     NULL,
     FALSE,
    ...
    ('ertcbn',
     'https://www.sivalabs.in/running-custom-spring-initializr',
     1,
     '2024-07-17 00:00:00',
     NULL,
     FALSE,
    ...
    ('edfrtg',
     'https://www.sivalabs.in/an-email-template-of-asking-for-technical-help',
     1,
     '2024-07-18 00:00:00',
     NULL,
     TRUE,
    ...
    ('2wedfg',
     'https://www.sivalabs.in/getting-started-with-spring-ai-and-open-ai',
     1,
     '2024-07-27 00:00:00',
     NULL,
     TRUE,
    ...
    ('ffr4rt',
     'https://www.sivalabs.in/generative-ai-conversations-using-langchain4j-chat-memory',
     1,
     '2024-08-10 00:00:00',
     NULL,
     FALSE,
    ...
    ('cvbg5t',
     'https://www.sivalabs.in/go-for-java-springboot-developers',
     1,
     '2024-08-12 00:00:00',
     NULL,
     FALSE,
    ...
    ('nm6ytf',
     'https://www.sivalabs.in/spring-boot-jooq-tutorial-fetching-many-to-many-associations',
     1,
     '2024-08-13 00:00:00',
     NULL,
     FALSE,
